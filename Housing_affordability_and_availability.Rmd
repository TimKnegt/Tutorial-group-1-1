...
Huizenprijzen & Huizenvoorraad per provincie <- read_csv("data 2.0/Huizenprijzen_Huizenvoorraad_nieuw.csv")
...
## 3.1 Data cleaning
We clean all of our datasets to make it more clear and simplified. We do this because by default some have strange and long titles that make it hard to work with. In this part we use 4 function to clean up and/or merge each dataset.
