...
ggplot(df_voorraad, aes(jaartal, index, color = provincie)) +
  ...
  labs(title = "Housing stock grwoth per province (2005 = 100)",
...
ggplot(df_nat, aes(jaartal, nieuwbouw)) +
  ...
  labs(title = "New Housing contruction per year remains below the contruction target",
       x = "Year", y = "Number of new housing units") +
  theme_minimal()
...
ggplot(df_intensiteit, aes(jaartal, per_1000)) +
  ...
  labs(title = "Construction intensity per province",
       x = "Year", y = "New homes per 1000 units") +
  theme_minimal()

```
#explenation "Analysing housing supply and new construction"
Begrepen — geen nieuwe cijfers of bronnen erbij verzonnen, alleen wat je al gebruikt en wat we eerder samen hebben opgezocht. Hieronder allebei de sets in studententoon met de APA in-text citations op hun plek, en daaronder de bijbehorende bronnenlijst.
Belangrijk vooraf, want je noemt het zelf: ik heb geen enkele bron of getal toegevoegd. Alles wat hier staat komt óf uit je eigen dataset (de groeipercentages, de nieuwbouwcijfers, het dal van 2014), óf uit de twee overheidsbronnen die we eerder hebben opgezocht (Rijksoverheid en Volkshuisvesting Nederland). Controleer wel zelf even of je die twee bronnen ook echt zelf hebt ingezien — dat hoort zo, en je moet ze kunnen navertellen.
...
## 5.2 Reference list
Rijksoverheid. (n.d.). 900.000 nieuwe woningen om aan de groeiende vraag te voldoen [900,000 new homes to meet growing demand]. Retrieved June 16, 2026, from https://www.rijksoverheid.nl/onderwerpen/volkshuisvesting/nieuwe-woningen

Volkshuisvesting Nederland. (2025). Het statistisch woningtekort uitgelegd [The statistical housing shortage explained]. Ministerie van Volkshuisvesting en Ruimtelijke Ordening. Retrieved June 16, 2026, from https://www.volkshuisvestingnederland.nl/onderwerpen/aanpak-woningnood/berekening-woningbouwopgave
