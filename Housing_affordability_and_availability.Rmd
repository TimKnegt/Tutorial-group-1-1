...
```
#explenation "Analysing housing supply and new construction"
...
To get started we will change the dataset containing the information about population growth and rename the collums using the rename() function, so it is easier to comprehend. After that we only select the usefull information via transmute(). And lastly we put the variable for time in the first collum to improve the look of the table.
```{r}
