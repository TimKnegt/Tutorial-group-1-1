...
```{r loading_data}
data <- read.csv("data/Huizenprijzen_Huizenvoorraad.csv")
head(data)
```
...
bevolkingsgroei <- bevolkingsgroei %>%
  rename( Jong_volwassenen = Bevolking.op.1.januari.Naar.leeftijd.20.tot.45.jaar..x.1.000.)
