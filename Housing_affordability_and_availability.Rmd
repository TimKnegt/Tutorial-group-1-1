...
variables <- data.frame(
  Variable = c("Jaartal/Jaren", "jong_volwassenen_20_tot_45_jaar","Huizenvoorraad", "Max_nominal_mortgage_loan_euro", "Max_real_mortgage_loan_euro", "Gemiddelde_verkoopprijs_euro_Totaal_woningen", "Gemiddelde_verkoopprijs_euro_Tussenwoning" ,"Gemiddelde_verkoopprijs_euro_Appartement", "Gemiddelde_verkoopprijs_euro_Hoekwoning"),
...
variables <- data.frame(
  Variable = c(
    ...
    "Gemiddelde_verkoopprijs_euro_Totaal_woningen",
    "Gemiddelde_verkoopprijs_euro_Tussenwoning",
    "Gemiddelde_verkoopprijs_euro_Appartement",
    "Gemiddelde_verkoopprijs_euro_Hoekwoning",
    "provincie",
    "index",
    "per_1000"
  ),
...
## Conclusion
Our analysis comes with a few limitations, namely that we could not access population growth figures for this specific age group beyond 2019. Even so, we expect population growth will remain relatively stable in the period 2019-2026. On the contrary, new housing construction looks quite different in this period. Development is heavily constrained by the ongoing environmental regulation, particularly the "stikstofcrisis" (nitrogencrisis)(Liefting & Berkhout, 2025). Due to this bottleneck, we expect to see a significant reduction in the number of new homes being built in this timeframe. Taking this into account, we see that the housing shortage is caused by a temporal decline in the construction(2009-2014) and expected decline after 2019. All while population growth stays relatively the same.
...
-DNB. (n.d.). Onze hoge hypotheekschulden – risico’s en oplossingen. De Nederlandsche Bank. https://www.dnb.nl/actuele-economische-vraagstukken/woningmarkt/onze-hoge-hypotheekschulden-risico-s-en-oplossingen/

-Hypotheken, H. (2026, June 20). Wat is de LTI hypotheek en hoe bepaalt het jouw maximale hypotheek? HomeFinance. https://www.homefinance.nl/hypotheek/informatie/lti-hypotheek/
